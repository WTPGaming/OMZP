...
/*    */ 
/*    */ public class MinersLampConfig implements Listener {
/*    */   OMZP plugin;
/*    */   
/*    */   public MinersLampConfig(OMZP plugin) {
/* 12 */     this.plugin = plugin;
/*    */ 
/*    */     
/* 15 */     String item = "MinersLamp";
/*    */ 
/*    */     
...
/* 31 */       plugin.getConfig().set(item + "-Name", ChatColor.ITALIC + "Miner's Lamp");
/*    */     }
/*    */ 
/*    */     
/* 35 */     if (Material.getMaterial(plugin.getConfig().getString(item + "-Type")) == null)
/* 36 */       plugin.getConfig().set(item + "-Type", "GOLDEN_HEMLET"); 
/*    */   }
/*    */ }


/* Location:              D:\Austin\Downloads\OMZP-1.0.1.jar!\com\wtpgaming\omzp\v15\Config\CustomItems\Armor\Helmets\MinersLampConfig.class
