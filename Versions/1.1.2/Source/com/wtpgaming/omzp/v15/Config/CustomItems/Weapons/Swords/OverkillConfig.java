...
/*    */ 
/*    */ public class OverkillConfig implements Listener {
/*    */   OMZP plugin;
/*    */   
/*    */   public OverkillConfig(OMZP plugin) {
/* 12 */     this.plugin = plugin;
/*    */ 
/*    */     
/* 15 */     String item = "Overkill";
/*    */ 
/*    */     
...
/* 26 */       plugin.getConfig().set(item + "-Description", ChatColor.LIGHT_PURPLE + "Deals damage to the player hit, but gives the user Weakness.");
/*    */     }
/*    */ 
/*    */     
/* 30 */     if (plugin.getConfig().getString(item + "-Name") == null) {
/* 31 */       plugin.getConfig().set(item + "-Name", ChatColor.ITALIC + "Overkill");
/*    */     }
/*    */ 
/*    */     
/* 35 */     if (Material.getMaterial(plugin.getConfig().getString(item + "-Type")) == null) {
/* 36 */       plugin.getConfig().set(item + "-Type", "DIAMOND_SWORD");
/*    */     }
/*    */ 
/*    */     
...
/* 48 */       plugin.getConfig().set(item + "-Damage", "12");
/*    */     } 
/*    */ 
/*    */     
/*    */     try {
...
/* Location:              D:\Austin\Downloads\OMZP-1.1.2.jar!\com\wtpgaming\omzp\v15\Config\CustomItems\Weapons\Swords\OverkillConfig.class
